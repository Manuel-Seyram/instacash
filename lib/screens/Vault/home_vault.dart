...
import 'package:instacash/screens/Vault/Lump%20Sum/lump_sum_tab.dart';
                  ...
                  Align(
                    ...
                    child: RichText(
                      text: TextSpan(children: [
                        TextSpan(
                          text:
                              'Please select your investment or savings type\nfrom the options below to proceed',
                          style: GoogleFonts.poppins(
                            textStyle: const TextStyle(
                                color: Colors.white,
                                fontSize: 14.0,
                              ...
                              GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  child: Column(children: [
                                    ...
                                    Image.asset('assets/lumpsum.png',
                                    ...
                                    Align(
                                      alignment:
                                          const AlignmentDirectional(-0.5, 5.0),
                                      child: Text(
                                        'Vault\nInvestment',
                                        style: GoogleFonts.poppins(
                                          textStyle: const TextStyle(
                              ...
                              GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  child: Column(children: [
                                    ...
                                    Image.asset('assets/PayCheck.png',
                                        height: 60.0, width: 60.0),
                                    const SizedBox(
                                      height: 12.0,
                                    ),
                      ...
                      child: Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              Image.asset('assets/roundup.png',
                              ...
                              Column(
                                children: [
                                  ...
                                  Align(
                                    alignment:
                                        const AlignmentDirectional(-0.7, 5.0),
                                    child: Text(
                                      'GHS 25.50',
                                      style: GoogleFonts.poppins(
                                        textStyle: const TextStyle(
                                  ...
                                  Align(
                                    alignment:
                                        const AlignmentDirectional(-0.65, 5.0),
                                    child: Text(
                                      'Total savings',
                                      style: GoogleFonts.poppins(
                                        textStyle: const TextStyle(
