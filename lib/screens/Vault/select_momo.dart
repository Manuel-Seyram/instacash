...
class SelectMomoVault extends StatefulWidget {
  const SelectMomoVault({super.key});

  @override
  State<SelectMomoVault> createState() => _SelectMomoVaultState();
}

class _SelectMomoVaultState extends State<SelectMomoVault> {
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            const LumpSumMomoContinueButton(),
          ],
        ),
      ),
    );
