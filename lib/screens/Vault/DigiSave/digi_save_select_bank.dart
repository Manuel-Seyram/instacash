...
class SelectBankDigiSave extends StatefulWidget {
  const SelectBankDigiSave({super.key});

  @override
  State<SelectBankDigiSave> createState() => _SelectBankDigiSaveState();
}

class _SelectBankDigiSaveState extends State<SelectBankDigiSave> {
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            const DigiSaveBankContinueButton(),
          ],
        ),
      ),
    );
