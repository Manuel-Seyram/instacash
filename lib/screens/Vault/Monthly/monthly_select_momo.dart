...
class SelectMomoMonthly extends StatefulWidget {
  const SelectMomoMonthly({super.key});

  @override
  State<SelectMomoMonthly> createState() => _SelectMomoMonthlyState();
}

class _SelectMomoMonthlyState extends State<SelectMomoMonthly> {
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            const MonthlyMomoContinueButton(),
          ],
        ),
      ),
    );
