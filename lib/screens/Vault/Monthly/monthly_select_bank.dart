...
class SelectBankMonthly extends StatefulWidget {
  const SelectBankMonthly({super.key});

  @override
  State<SelectBankMonthly> createState() => _SelectBankMonthlyState();
}

class _SelectBankMonthlyState extends State<SelectBankMonthly> {
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            const MonthlyBankContinueButton(),
          ],
        ),
      ),
    );
