...
class SelectBankVault extends StatefulWidget {
  const SelectBankVault({super.key});

  @override
  State<SelectBankVault> createState() => _SelectBankVaultState();
}

class _SelectBankVaultState extends State<SelectBankVault> {
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            const LumpSumBankContinueButton(),
          ],
        ),
      ),
    );
