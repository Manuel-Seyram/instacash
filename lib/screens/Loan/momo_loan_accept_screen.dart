...
import 'package:instacash/screens/Loan/Loan%20widgets/momo_loan_payment_method.dart';
import 'package:instacash/widgets/instacash_buttons.dart';

class MomoReceipt extends StatefulWidget {
  const MomoReceipt({super.key});

  @override
  State<MomoReceipt> createState() => _MomoReceiptState();
}

class _MomoReceiptState extends State<MomoReceipt> {
    ...
    return Scaffold(
      ...
      Column(
        children: [
          ...
          const SizedBox(height: 20.0,),
          const LoanMomoPaymentMethodContainer(),
          const SizedBox(height: 20.0,),
    Align(
      alignment: const AlignmentDirectional(-0.61, 5.0),
      child:
