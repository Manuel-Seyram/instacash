...
import 'package:instacash/screens/Loan/Loan%20widgets/bank_loan_payment_method_container.dart';
...
class BanKReceipt extends StatefulWidget {
  const BanKReceipt({super.key});

  @override
  State<BanKReceipt> createState() => _BanKReceiptState();
}

class _BanKReceiptState extends State<BanKReceipt> {
    ...
    return Scaffold(
      ...
      Column(
        children: [
          ...
          const SizedBox(height: 20.0,),
          const LoanPaymentMethodContainer(),
          const SizedBox(height: 20.0,),
    Align(
      alignment: const AlignmentDirectional(-0.61, 5.0),
      child:
